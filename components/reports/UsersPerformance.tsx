...
import { useUsersPerformance, useAttemptDetails } from '@/hooks/useUsersPerformance';
...
export function UsersPerformance({ initialExams }: { initialExams: any[] }) {
  const {
    searchTerm,
    setSearchTerm,
    sortConfig,
    ...
    showSchool,
    showDistrict,
  } = useUsersPerformance(initialExams);
