...
export function Footer({ className = '' }: { className?: string }) {
  return (
    <footer className={`w-full py-4 bg-[#1E293B] dark:bg-slate-900 shrink-0 text-center text-xs md:text-sm flex flex-col md:flex-row items-center justify-center gap-1.5 md:gap-3 z-50 ${className}`}>
