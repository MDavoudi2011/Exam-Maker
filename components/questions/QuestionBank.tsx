...
import { useQuestionBank, useEditModal } from '@/hooks/useQuestionBank';
import { useResponsivePagination } from '@/hooks/useResponsivePagination';
import { RenderContent } from '@/components/ui/RenderContent';
import { EditModal } from '@/components/questions/QuestionBankEditModal';
...
export function QuestionBank({ userRole = 'user' }: { userRole?: string }) {
  const {
    questions,
    topics,
    selectedTopic,
